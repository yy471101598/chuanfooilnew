package com.shoppay.wyoilnew.adapter;
...
public class OilChoseAdapter extends BaseAdapter {
    ...
    public OilChoseAdapter(Context context, List<OilType> items) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OilType item = items.get(position);
        holder.tv_car.setText(item.OilName);
        return convertView;
    }
