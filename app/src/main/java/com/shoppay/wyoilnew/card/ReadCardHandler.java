package com.shoppay.wyoilnew.card;
 ...
 * 联系方式QQ：398320879
 */
public class ReadCardHandler extends Activity {
     ...
     *
     */
    public ReadCardHandler(InterfaceBack back) {
        this.back = back;
...
//                        mMifareCardNumber = String.valueOf(Long.parseLong(payCardInfo.uuid, 16));
                         ...
                         * 默认显示通用卡号
                         */
                        back.onResponse(mMifareCardNumber);
//                        textView.setText(mMifareCardNumber);
                    } else {
                        /***************Mag磁条卡*********************/
                        mCardNumber = payCardInfo.track2;
                        back.onResponse(String.format("%010d", mCardNumber));
//                        textView.setText(String.format("%010d", mCardNumber));
                    }
                    break;
            }
        }
