package com.shoppay.wyoilnew.http;

import com.shoppay.wyoilnew.bean.Login;
import com.shoppay.wyoilnew.bean.Yuming;
...
public interface RetrofitAPI {
     ...
     */
    @FormUrlEncoded
    @POST("PosJi/API/AppPub.ashx?Method=AppGetDomain")
    Call<Yuming> obtainYuming(@FieldMap Map<String, Object> map);
